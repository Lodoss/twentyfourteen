...
foreach ($this->catlist->get_categories_posts() as $single){
 ...
 // $lcp_display_output .= "<li>";
    $lcp_display_output .= '<article id="post-51" class="post-51 post type-post status-publish format-standard has-post-thumbnail hentry category-allgemein has-post-thumbnail">
';
    ...
    <header class="entry-header">
			...
			<span class="cat-links"><a href="http://localhost/ahmadiyya/category/allgemein/" title="View all posts in Allgemein" rel="category tag">Allgemein</a></span>
		</div><h1 class="entry-title">';
   // $lcp_display_output .= '<h1 class="entry-title"><a href="http://localhost/ahmadiyya/ameen-ceremony/" rel="bookmark">Ameen Ceremony</a></h1>';
    $lcp_display_output .= $this->get_post_title($single);
    $lcp_display_output .= '</h1><div class="entry-meta">
						<!--<span class="comments-link"><a href="http://localhost/ahmadiyya/ameen-ceremony/#respond" title="Comment on Ameen Ceremony">Leave a comment</a></span>
			<span class="edit-link"><a class="post-edit-link" href="http://localhost/ahmadiyya/wp-admin/post.php?post=51&amp;action=edit">Edit</a></span>-->		</div><!-- .entry-meta -->
	</header><!-- .entry-header -->
    ';
 ...
 // $lcp_display_output .= ' ' . $this->get_date($single);
   ...
   */
    ...
    $lcp_display_output .= $this->get_excerpt($single, 'div', 'lcp_excerpt entry-summary');
