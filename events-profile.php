<?php
/**
 * The template for displaying events Archives based on profile pages
 * 
 ...
 */
/*
Template Name:Filter Event Archive
*/
	...
	<section id="primary" class="content-area">
		...
		<?php if ( $books->have_posts() ) : ?>
				...
				<h1 class="page-title">
					<?php
						...
						elseif ( is_year() ) :
							...
							_e( 'Events Archives', 'twentyfourteen' );
			...
			<?php
					...
					//get_template_part( 'content-events', 'none' );
