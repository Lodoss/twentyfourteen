...
function twentyfourteen_widgets_init() {
	...
	register_sidebar( array(
		'name'          => __( 'The Friday Sermon Sidebar', 'twentyfourteen' ),
		'id'            => 'sidebar-5',
		'description'   => __( 'Additional sidebar that appears on the right.', 'twentyfourteen' ),
		'before_widget' => '<aside id="%1$s" class="widget %2$s">',
		'after_widget'  => '</aside>',
	...
	register_sidebar( array(
		'name'          => __( 'The Books Library Sidebar', 'twentyfourteen' ),
		'id'            => 'sidebar-6',
		'description'   => __( 'Additional sidebar that appears on the right.', 'twentyfourteen' ),
		'before_widget' => '<aside id="%1$s" class="widget %2$s">',
		'after_widget'  => '</aside>',
	...
	register_sidebar( array(
		'name'          => __( 'The Photo Gallery Sidebar', 'twentyfourteen' ),
		'id'            => 'sidebar-7',
		'description'   => __( 'Additional sidebar that appears on the right.', 'twentyfourteen' ),
		'before_widget' => '<aside id="%1$s" class="widget %2$s">',
		'after_widget'  => '</aside>',
	...
	register_sidebar( array(
		'name'          => __( 'The Page Sidebar', 'twentyfourteen' ),
		'id'            => 'sidebar-8',
		'description'   => __( 'Additional sidebar that appears on the right.', 'twentyfourteen' ),
		'before_widget' => '<aside id="%1$s" class="widget %2$s">',
		'after_widget'  => '</aside>',
	...
	register_sidebar( array(
		'name'          => __( 'The Events Sidebar', 'twentyfourteen' ),
		'id'            => 'sidebar-9',
		'description'   => __( 'Additional sidebar that appears on the right.', 'twentyfourteen' ),
		'before_widget' => '<aside id="%1$s" class="widget %2$s">',
		'after_widget'  => '</aside>',
