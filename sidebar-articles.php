            ...
            <aside id="categories-3" class="widget widget_categories">
				...
				if ( $the_query->have_posts() ) {
					...
					while ( $the_query->have_posts() ) {
						$the_query->the_post();
						?>
								<li class="cat-item"><a href="<?php echo get_bloginfo('url') ?>/profile-articles/?pid=<?php echo get_the_ID() ?>" title=""><?php echo  get_the_title(). " (".get_post_meta( get_the_ID(), 'wpcf-profile-position', true ).")"; ?></a></li>
					<?php
					}
				} else {
					//echo ' no posts found';
